...
export class InitSchema1749941738575 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`flights\` (\`id\` int NOT NULL AUTO_INCREMENT, \`flight_date\` varchar(255) NOT NULL, \`flight_status\` varchar(255) NOT NULL, \`departure\` json NOT NULL, \`arrival\` json NOT NULL, \`airline\` json NOT NULL, \`flight\` json NOT NULL, \`aircraft\` json NULL, \`live\` json NULL, \`dep_iata\` varchar(255) NULL, \`arr_iata\` varchar(255) NULL, \`flight_number\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    }
